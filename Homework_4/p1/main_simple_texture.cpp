...
int main(int argc, const char * argv[])
{
    ...
    int texid = texture->loadAndCreateTexture("../data/textures/green_dragon.bmp");
    ...
    GLPlane3D* plane_0 = new GLPlane3D(0.0, 0.0, 0.0, 65.0, 65.0);
    plane_0->setApperance(*apperance_0);
    plane_0->init();

	/*GLPlane3D* plane_1 = new GLPlane3D(15.0, 0.0, 0.0, 25.0, 25.0);
