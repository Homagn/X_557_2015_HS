...
void main(void)                                                   
{
    ...
    {
        color = ((tex_color_light)*tex_color+(tex_color)*tex_color_dark+(tex_color_dark)*tex_color
		+(tex_color)*tex_color_light+(tex_color_dark)*tex_color+(tex_color)*tex_color_dark)*0.5 ;
    }
    else
    {
