...
int main(int argc, const char * argv[])
{
	...
	sphere1->GLSphere1(-5.0, 0.0, 0.0, 2.0, 40, 20);
	sphere2->GLSphere2(0.0, 0.0, 0.0, 2.0, 40, 20);
	sphere3->GLSphere3(5.0, 0.0, 0.0, 2.2, 320, 160);
	sphere4->GLSphere4(10.0, 0.0, 0.0, 2.0, 320, 160);
	//GLSphere2(5.0, 0.0, 0.0, 2.0, 40, 20);
