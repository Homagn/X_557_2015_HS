...
#else
	const string      _glsl_names[4] = { "tex","tex1","tex2", "texture_blend"};
#endif
...
private:
    ...
    static string      _glsl_names[];
#else
    const string      _glsl_names[4] = { "texture_background","texture_midground", "texture_foreground", "texture_blend"};
#endif
...
public:
    ...
    /*!
     ...
     @return int - the texture id when the texture was sucessfully loaded.
     */
	int loadAndCreateTextures(string path_and_file_texture_1, string path_and_file_texture_2, string path_and_file_texture_3, int k);
	int _modelno = -1;
