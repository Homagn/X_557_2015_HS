...
void GLSphere::changecenter(float a, float b, float c)
{
	_center.x() = a;
	_center.y() = b;
	_center.z() = c;
...
void GLSphere::GLSphere1(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
...
void GLSphere::GLSphere2(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
...
void GLSphere::GLSphere3(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
...
void GLSphere::GLSphere4(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
 ...
 */
void GLSphere::initShader1(void)
{
    ...
    _light_source0._lightPos = glm::vec4(30.0,10.0,30.0,1.0);
    _light_source0._ambient_intensity = 0.2;
...
void GLSphere::initShader2(void)
{
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(50.0, 10.0, 60.0, 1.0);
	_light_source0._ambient_intensity = 0.2;
...
void GLSphere::initShader3(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.0, 0.9, 0.0);
	_material._ambient_material = glm::vec3(0.0, 0.9, 0.0);
	_material._specular_material = glm::vec3(0.2, 0.9, 0.2);
	...
	// define the position of the light and send the light position to your shader program
	_light_source1._lightPos = glm::vec4(6.0, -2.0, 8.1, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 5.0;
	_light_source1._diffuse_intensity = 3.0;

	_light_source1._cone_angle = 15.0;
	_light_source1._cone_direction = glm::vec3(-12.0, 28.0, -55.2);
...
void GLSphere::initShader4(void)
{
	...
	//glAttachShader(_program, vs);
	//glAttachShader(_program, fs);
	_program = LoadAndCreateShaderProgram("../data/shaders/spotlightcombi.vs", "../data/shaders/spotlightcombi.fs");
	...
	_light_source1._lightPosIdx = glGetUniformLocation(_program, "light_position");
	_light_source0._lightPosIdx = glGetUniformLocation(_program, "light_position2");
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// Material
	_material._diffuse_material = glm::vec3(0.90, 0.83, 0.25);
	_material._ambient_material = glm::vec3(0.90, 0.83, 0.25);
	_material._specular_material = glm::vec3(0.90, 0.83, 0.25);
	_material._shininess = 100.0;
	...
	// define the position of the light and send the light position to your shader program
	_light_source0._lightPos = glm::vec4(5.0, -5.5, 10.0, 1.0);
	_light_source0._ambient_intensity = 0.0;
	_light_source0._specular_intensity = 0.7;
	_light_source0._diffuse_intensity = 1.0;



	_light_source0._ambientIdx = glGetUniformLocation(_program, "ambient_intensity2");
	_light_source0._diffuseIdx = glGetUniformLocation(_program, "diffuse_intensity2");
	_light_source0._specularIdx = glGetUniformLocation(_program, "specular_intensity2");
	...
	// define the position of the light and send the light position to your shader program
	_light_source1._lightPos = glm::vec4(11.5, -1.5, 8.1, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 0.4;
	_light_source1._diffuse_intensity = 0.2;

	_light_source1._cone_angle = 12.0;
	_light_source1._cone_direction = glm::vec3(-12.0, 28.0, -55.2);
...
void GLSphere::initShader(void)
{
	...
	_light_source0._diffuse_intensity = 5.0;
