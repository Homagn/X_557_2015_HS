...
static const string vs_string_GLSphere1_410 =
"#version 410 core                                                 \n"
"                                                                   \n"
...
static const string vs_string_GLSphere1_300 =
"#version 310 core                                                 \n"
"                                                                   \n"
"uniform mat4 projectionMatrixBox;                                    \n"
"uniform mat4 viewMatrixBox;                                           \n"
...
static const string fs_string_GLSphere1_410 =
"#version 410 core                                                 \n"
"                                                                  \n"
"in vec3 pass_Color;                                                 \n"
"out vec4 color;                                                    \n"
...
static const string fs_string_GLSphere1_300 =
"#version 310 core                                                 \n"
"                                                                  \n"
"                                                                   \n"
"                                                                   \n"
...
void GLSphere1::initShader(void)
{
	...
	static const char * vs_source = vs_string_GLSphere1_410.c_str();

	// Fragment shader source code. This determines the colors in the fragment generated in the shader pipeline. In this case, it colors the inside of our triangle specified by our vertex shader.
	// static const string fragment_code = fs_string_CoordSystem;
	static const char * fs_source = fs_string_GLSphere1_410.c_str();
	...
	_material._ambient_material = glm::vec3(0.0, 0.0, 0.1);
	...
	_light_source0._lightPos = glm::vec4(2.0, 0.0, 50.0, 1.0);
...
void GLSphere1::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
