...
public:
	...
	void GLSphere1(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10);
	void GLSphere2(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10);
	void GLSphere3(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10);
	void GLSphere4(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10);
...
protected:
     ...
     */
    virtual void initVBO1(void);
    
    /*
     Inits the shader program for this object
     */
    virtual void initShader1(void);
	virtual void initShader(void);
	virtual void initVBO(void);

	virtual void initVBO2(void);

	/*
	Inits the shader program for this object
	*/
	virtual void initShader2(void);

	virtual void initVBO3(void);

	/*
	Inits the shader program for this object
	*/
	virtual void initShader3(void);

	virtual void initVBO4(void);

	/*
	Inits the shader program for this object
	*/
	virtual void initShader4(void);
    /*!
